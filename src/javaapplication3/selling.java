                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                    .addComponent(Csearch, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
...
//             Connection con = DriverManager.getConnection("jdbc:mysql://db4free.net/node_verse","rajaraman","Sql@2022");
    ...
    private void insertBill(){
             ...
             try {
                ...
                try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/node","root","Sql@2022")) {
                   int id =coutProd();
               
                    PreparedStatement pst = con.prepareStatement("INSERT INTO salesreport VALUES(?,?,?,?,?)");
                    // updating customer data
                    Statement st = con.createStatement();
                    ResultSet totals = st.executeQuery("SELECT total_purchase FROM customer  WHERE custome_number='"+CPhone.getText()+"'");
                    totals.next();
                    double pTotal =Double.parseDouble(totals.getString("total_purchase"));
                    System.out.print(grandTotal+pTotal);
                    double pushToatl = grandTotal+pTotal;
                    
                    PreparedStatement pst1 = con.prepareStatement("UPDATE customer SET total_purchase=? WHERE custome_number='"+CPhone.getText()+"'");
                    ...
                    pst.executeUpdate();
                    con.close();
                    try (Connection cone = DriverManager.getConnection("jdbc:mysql://db4free.net/node_verse","rajaraman","Sql@2022")) {
                       Statement sto = cone.createStatement();
                        for (int i : hm.keySet()) {
                            ResultSet qty = sto.executeQuery("SELECT Qty FROM products  WHERE id='"+i+"'");
                            qty.next();
                            int PQty =Integer.parseInt(qty.getString("Qty"));
                            int hQty=hm.get(i);
                            PreparedStatement updateStock = cone.prepareStatement("UPDATE products SET Qty=? WHERE id='"+i+"'");
                            int updatedQty=PQty-hQty;
                            updateStock.setInt(1, updatedQty);
...
//            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/node","root","Sql@2022");
    ...
    private void SPTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SPTableMouseClicked
        ...
        selectedQty=Integer.parseInt(model.getValueAt(row, 3).toString());
    ...
    private void SPAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SPAddActionPerformed
        ...
        }else if(Integer.parseInt(SPQty.getText()) > selectedQty){
           JOptionPane.showMessageDialog(this,"Product Out of Stock Range"); 
        }else{
        ...
        int qty=Integer.parseInt(SPQty.getText());
...
//            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/node","root","Sql@2022");
    ...
    private int cCount(){
       ...
       private void showCustomer() throws SQLException, ClassNotFoundException{
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/node","root","Sql@2022");
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("SELECT * FROM node.customer");
        ...
        if(CName.getText().isEmpty() || CPhone.getText().isEmpty()){
            ...
            try {
                ...
                try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/node","root","Sql@2022")) {
                      ...
                      Statement st = con.createStatement();
                      ResultSet rs = st.executeQuery("SELECT * FROM customer WHERE custome_number like '" + CPhone.getText() + "%'");
                    if(!rs.next()){  
                    int id =cCount();
                    ...
                    JOptionPane.showMessageDialog(this,"Customer Added"); 
                      ...
                      JOptionPane.showMessageDialog(this,"Customer Found select from field"); 
                       try{// TODO add your handling code here:
                        Class.forName("com.mysql.cj.jdbc.Driver");
                        Connection cone = DriverManager.getConnection("jdbc:mysql://localhost:3306/node","root","Sql@2022");
                        Statement stc = cone.createStatement();
                        ResultSet rsc = stc.executeQuery("SELECT * FROM customer WHERE custome_number like '" + CPhone.getText() + "%'");
       ...
       if(!Csearch.getText().isEmpty()){
        try{// TODO add your handling code here:
         Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/node","root","Sql@2022");
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("SELECT * FROM customer WHERE custome_number like '" + Csearch.getText() + "%'");
            CTable.setModel(DbUtils.resultSetToTableModel(rs));
